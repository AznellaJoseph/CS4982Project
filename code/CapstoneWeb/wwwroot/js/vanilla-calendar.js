...
let VanillaCalendar = (function() {
    function VanillaCalendar(options) {
        ...
        const createDay = function(date) {
            ...
            const available_week_day =
                opts.availableWeekDays.filter(f => f.day === date.getDay() || f.day === getWeekDay(date.getDay()));
            const available_date = opts.availableDates.filter(f => f.date ===
                (date.getFullYear() +
                    "-" +
        ...
        const selectDate = function() {
            const activeDates = element.querySelectorAll("[data-calendar-status=active]");
